...
mapMetaRawStatement f (RawDeclStatement (RawDecl objArr)) = RawDeclStatement (RawDecl (mapMetaObjArr f Nothing objArr))
...
mapMetaRawStatement f (TypeDefStatement (TypeDef obj)) = TypeDefStatement (TypeDef (mapMeta f InputMeta obj))
